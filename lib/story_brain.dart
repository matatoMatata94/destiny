...
class StoryBrain {
  ...
  getStory() {
    return storyTitle = _storyData[_storyNumber].storyTitle;
  }

  getChoice1() {
    return choice1 = _storyData[_storyNumber].choice1;
  }

  getChoice2() {
    return choice2 = _storyData[_storyNumber].choice2;
  }

  nextStory({required int choiceNumber}) {
    if (_storyNumber == 0 && choiceNumber == 2) {
      _storyNumber = 1;
    } else if (_storyNumber == 0 && choiceNumber == 1) {
      _storyNumber = 2;
